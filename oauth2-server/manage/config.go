...
var (
	...
	DefaultAuthorizeCodeTokenCfg = &Config{AccessTokenExp: time.Hour * 24, RefreshTokenExp: time.Hour * 24 * 7, IsGenerateRefresh: true}
	DefaultImplicitTokenCfg      = &Config{AccessTokenExp: time.Hour * 24 * 7}
	DefaultPasswordTokenCfg      = &Config{AccessTokenExp: time.Hour * 24 * 7, RefreshTokenExp: time.Hour * 24 * 7, IsGenerateRefresh: true}
	DefaultClientTokenCfg        = &Config{AccessTokenExp: time.Hour * 24 * 7}
